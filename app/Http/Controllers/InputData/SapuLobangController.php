...
class SapuLobangController extends Controller
{
    ...
    {
        if(Auth::user()->id == 1){
            $forcedel_survei = Survei::where('uptd_id',3)->where('created_at','<=','2022-06-08 23:59:59')->get();
            ...
            $forcedel_survei_detail = SurveiDetail::where('uptd_id',3)->where('created_at','<=','2022-06-08 23:59:59')->get();
            ...
            $forcedel_rencana = RencanaPenanganan::where('uptd_id',3)->where('created_at','<=','2022-06-08 23:59:59')->get();
            ...
            $forcedel_rencana_detail = RencanaPenangananDetail::where('uptd_id',3)->where('created_at','<=','2022-06-08 23:59:59')->get();
            foreach($forcedel_rencana_detail as $data){
                $data->delete();
            }
    
            $forcedel_penanganan = Penanganan::where('uptd_id',3)->where('created_at','<=','2022-06-08 23:59:59')->get();
            ...
            $forcedel_penanganan_detail = PenangananDetail::where('uptd_id',3)->where('created_at','<=','2022-06-08 23:59:59')->get();
            ...
            $forcedel_potensi = Potensi::where('uptd_id',3)->where('created_at','<=','2022-06-08 23:59:59')->get();
            ...
            $forcedel_potensi_detail = PotensiDetail::where('uptd_id',3)->where('created_at','<=','2022-06-08 23:59:59')->get();
            foreach($forcedel_potensi_detail as $data){
                if($data->image)
                Storage::delete('public/survei_lubang/'.$data->image);
                $data->delete();
            }
            $forcedel_reject = SurveiReject::where('uptd_id',3)->where('created_at','<=','2022-06-08 23:59:59')->get();
            ...
            $color = "success";
            $msg = "force delete sukses !";
        }else{
            storeLogActivity(declarLog(3, 'Force Delete Lubang', Auth::user()->id.' : '.Auth::user()->name));
            $color = "danger";
    ...
    public function rekapitulasi(Request $request){
        ...
        foreach($data as $uptd){
            ...
            $panjang_lama = $uptd->survei_lubang()->where('tanggal','<=',$filter['tanggal_sebelum1'])->sum('panjang') - $uptd->penanganan_lubang_s()->where('tanggal','<=',$filter['tanggal_sebelum1'])->sum('panjang');
            $panjang_ditangani = $uptd->penanganan_lubang_s()->whereBetween('tanggal', [$filter['tanggal_awal1'] , $filter['tanggal_akhir1'] ])->sum('panjang');
            ...
            foreach($uptd->library_sup as $sup){
                $lubang_lama = $sup->survei_lubang()->where('tanggal','<=',$filter['tanggal_sebelum1'])->sum('jumlah') - $sup->penanganan_lubang_s()->where('tanggal','<=',$filter['tanggal_sebelum1'])->sum('jumlah');
                $lubang_baru = $sup->survei_lubang_s()->whereBetween('tanggal', [$filter['tanggal_awal1'] , $filter['tanggal_akhir1'] ])->sum('jumlah');
                $penanganan = $sup->penanganan_lubang_s()->whereBetween('tanggal', [$filter['tanggal_awal1'] , $filter['tanggal_akhir1'] ])->sum('jumlah');
                ...
                $panjang_lama =$sup->survei_lubang()->where('tanggal','<=',$filter['tanggal_sebelum1'])->sum('panjang') - $sup->penanganan_lubang_s()->where('tanggal','<=',$filter['tanggal_sebelum1'])->sum('panjang');
                $panjang_ditangani = $sup->penanganan_lubang_s()->whereBetween('tanggal', [$filter['tanggal_awal1'] , $filter['tanggal_akhir1'] ])->sum('panjang');
                $panjang_baru = $sup->survei_lubang()->whereBetween('tanggal', [$filter['tanggal_awal1'] , $filter['tanggal_akhir1'] ])->sum('panjang');
                $panjang =  $panjang_lama + $panjang_baru;
                $panjang =  $panjang - $panjang_ditangani;
                $ditangani = $sup->penanganan_lubang_s()->where('tanggal','<=',$filter['tanggal_akhir1'])->sum('panjang');
                ...
                $row->addCell(null)->addTextRun($angka)->addText($lubang_lama,$angka);
