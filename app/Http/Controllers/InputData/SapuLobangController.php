...
class SapuLobangController extends Controller
{
    ...
    public function synchronize(){
        if(Auth::user()->id == 1){
            ...
            storeLogActivity(declarLog(1, 'Singkronisasi Data Lubang', 'Seluruh Data Lubang'));
            $color = "danger";
    ...
    public function rekapitulasi(Request $request){
        ...
        $table->addCell(null, array('gridSpan' => 9, 'vMerge' => 'restart', 'valign' => 'center'))->addTextRun($centered)->addText("Jumlah Lubang",$th);
        ...
        $table->addCell(null, array('gridSpan' => 3, 'vMerge' => 'restart', 'valign' => 'center'))->addTextRun($centered)->addText("Panjang Ruas (Km)",$th);
        ...
        $row->addCell(1000, $cellRowSpan)->addTextRun($centered)->addText("Potensi",$th);
        $table->addCell(null, $cellRowContinue);
        ...
        $row->addCell(null, array('bgColor' => 'B8CCE4'))->addTextRun($centered)->addText("(15)",$th);
        ...
        foreach($data as $uptd){
            ...
            $row->addCell(null, $th2)->addTextRun($centered)->addText(" ",$th2);
            $row->addCell(null, $th2)->addTextRun($centered)->addText(" ",$th2);
            $row->addCell(null, $th2)->addTextRun($centered)->addText($potensi,$th2);
            ...
            $row->addCell(null, $th2)->addTextRun($centered)->addText(round($potensi_panjang/1000,2),$th2);
            $row->addCell(null, $th2)->addTextRun($centered)->addText(" ",$th2);
            ...
            foreach($uptd->library_sup as $sup){
                ...
                $row->addCell(null)->addTextRun($angka)->addText($potensi,$angka);
                ...
                $row->addCell(null)->addTextRun($angka)->addText(round($potensi_panjang/1000,2),$angka);
